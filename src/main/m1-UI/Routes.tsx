...
import {PasswordAssistanceContainer} from '../../features/f4-Password-assistance/a1-UI/PasswordAssistanceContainer'
...
const Routes: React.FC = () => {
    return (
        <div className={commonStyle.container}>
            ...
            <Route path={ Path.PASSWORD_ASSISTANCE_PATH } render={() => <PasswordAssistanceContainer/>}/>
